...
export const SKILLS: SkillGroup[] = [
  { category: "Design", skills: ["User Research", "Wireframing", "Prototyping", "Responsive Design", "Usability Testing"] },
  { category: "Tools", skills: ["Figma", "Adobe XD", "Sketch", "Power BI", "Tableau", "VS Code", "Git"] },
  { category: "Front-End", skills: ["HTML", "CSS"] },
  { category: "AI Tools", skills: ["OpenAI", "Lovable", "FlutterFlow", "Google Gemini", "Figma Make", "Google AI Studio"] }
];
